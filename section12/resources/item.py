...
class Item(Resource):
    ...
    parser.add_argument(
        "store_id", type=int, required=True, help="ID of store where the item belogs"
    )
    ...
    def get(self, name: str):
        ...
        if found_item:
            return (
                found_item.json(),
                200,
            )  # calling the method json() from ItemModel class, because i need to return JSON, not the object instance
    ...
    def post(self, name: str):
        ...
        try:
            ...
            return {
                "message": "error when inserting item to database"
